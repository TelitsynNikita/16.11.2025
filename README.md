...
## Какие возникли вопросы перед разработкой проекта
1. Должны ли храниться данные в оперативе и теряться при перезапуске сервера?
2. Нужно ли валидировать поля во входящих запросах?